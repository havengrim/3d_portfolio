...
// console.log('Public Key:', import.meta.env.VITE_APP_EMAILJS_PUBLIC_KEY);
    ...
    emailjs.send(
      ...
      import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
      {
        ...
        to_email: 'angeloguiao.gci@gmail.com',
      ...
      <div className='flex-1 min-w-[50%] flex flex-col'>
        ...
        <form className='w-full flex flex-col gap-7 mt-14' onSubmit={handleSubmit} ref={formRef}>
          <label className='text-black-500 font-semibold'>
            Name
            <input type='text' name='name' className='input' placeholder='John' required valu={form.name} onChange={handleChange} onFocus={handleFocus} onBlur={handleBlur}/>
          </label>
          <label className='text-black-500 font-semibold'>
            Email
            <input type='email' name='email' className='input' placeholder='angeloguiao@gmail.com' required valu={form.email} onChange={handleChange} onFocus={handleFocus} onBlur={handleBlur}/>
          </label>
          <label className='text-black-500 font-semibold'>
            Your Message
            <textarea
